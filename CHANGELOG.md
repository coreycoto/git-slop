...
first-run handoff, decision surfaces, severity-safe health output, canonical
verification, precise receipts and estimates, a decision-first portable report,
behavior coverage, hotspot decomposition, and machine-readable contributor CI.

See the [complete numbered 0.15.0 release notes](docs/releases/0.15.0.md).
...
- [0.10.0 and 0.10.1](docs/releases/changelog-0.10.md)
