...
The examples below pin `v0.11.7`. Use them only after its verified GitHub
...
| --- | --- | --- |
| `version` | `0.11.7` | Prebuilt release version to download and verify |
...
2FA. Marketplace and direct `uses: coreycoto/git-slop@v0.11.7` installation then
