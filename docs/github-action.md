...
The examples below pin `v0.9.5`. Use them only after its verified GitHub
...
| --- | --- | --- |
| `version` | `0.9.5` | Prebuilt release version to download and verify |
...
2FA. Marketplace and direct `uses: coreycoto/git-slop@v0.9.5` installation then
