...
The examples below pin `v0.9.3`. Use them only after its verified GitHub
...
| --- | --- | --- |
| `version` | `0.9.3` | Prebuilt release version to download and verify |
...
2FA. Marketplace and direct `uses: coreycoto/git-slop@v0.9.3` installation then
