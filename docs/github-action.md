...
The examples below pin `v0.9.4`. Use them only after its verified GitHub
...
| --- | --- | --- |
| `version` | `0.9.4` | Prebuilt release version to download and verify |
...
2FA. Marketplace and direct `uses: coreycoto/git-slop@v0.9.4` installation then
