---
name: install-update
description: Install or update the git-slop CLI from a GitHub release wheel or the Homebrew tap. Use when a repository or machine needs a usable git-slop binary before running reports.
---
