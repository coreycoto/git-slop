...
fn render_live_decision(result: &Value) -> Result<String> {
    ...
    let evidence_digests = [
        ("Immutable source results SHA-256", "source_results_sha256"),
        ("Private review manifest SHA-256", "review_manifest_sha256"),
        ("Manual ratings SHA-256", "manual_ratings_sha256"),
    ]
    .into_iter()
